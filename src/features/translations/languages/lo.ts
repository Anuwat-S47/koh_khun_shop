export const lo = {
  ...
  foodType: {
    ...
    add: "ເພີ່ມປະເພດສິນຄ້າ",
    editfoodType: "ແກ້ໄຂປະເພດສິນຄ້າ",
    editDescription: "ແກ້ໄຂຂໍ້ມູນປະເພດສິນຄ້າ",
    name: "ຊື່ປະເພດ",
    foodTypePlaceholder: "ເຊັ່ນ ອາຫານຈານດຽວ",

    count: "ປະເພດ",
    empty: "ຍັງບໍ່ມີປະເພດສິນຄ້າ",
    loadFailed: "ບໍ່ສາມາດໂຫຼດປະເພດສິນຄ້າໄດ້",
    deleteConfirm: "ທ່ານຕ້ອງການລຶບປະເພດສິນຄ້ານີ້ບໍ?",
    addSuccess: "ເພີ່ມປະເພດສິນຄ້າສຳເລັດແລ້ວ",
